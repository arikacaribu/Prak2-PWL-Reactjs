    ...
    <div className="container-fluid text-center text-md-left">
      <div className="row">
        <div className="col-md-6 mt-md-0 mt-3">
          <h5 className="text-uppercase">Cristian Ari</h5>
          <p>
        ...
        <h5 className="text-uppercase">KONTAK</h5>
          <ul className="list-unstyled"> 
            <li>
              <a  style={{color:'white', textDecoration:'none'}} href="#!"></a>
            </li>
            <li>
              <a href="#!"  style={{color:'white', textDecoration:'none'}}>email : kacari.14115.056student.itera.ac.id</a>
            </li>
